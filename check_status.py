...
def get_batch_status(batch_id, api_key):
    """
    This function retrieves the status of a batch email verification request from the Emailable API.

    Args:
        batch_id (str): The ID of the batch.
        api_key (str): The API key for the Emailable API.

    Returns:
        str: The status message of the batch.
    """
    # Construct the URL
...
if __name__ == "__main__":
    """
    This script checks the status of a batch email verification request. 
    It keeps checking the status every 30 seconds until the verification is completed.
    """
